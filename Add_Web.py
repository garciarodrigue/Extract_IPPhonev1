...
<div class="container">
    <div class="div-ip">
        <h1 class="h1-tt">IPs almacenadas <sub>base de datos</sub></h1>
        <br>
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha384-JzqCgho79lI4HX2LXP+3Y34s6d5bl8MTAi8Exx1gxCJnZwGFNk1olGnZv6H00r+4" crossorigin="anonymous"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.3.1/dist/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3g+IxwKJ8KviEBhFgL/6L6t6H7jIq0kccO5Z4K/VDDI0XYYnho" crossorigin="anonymous"></script>
</body>
</html>
